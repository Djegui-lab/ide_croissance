...
if uploaded_file:
    ...
    # -- GROUP DATAFRAME
    output_columns = ["Croissance du PIB (% annuel)", "investissement"]
    ...
    fig = px.bar(
        ...
        x=groupby_column,
        y='code_pays',
        color="Croissance du PIB (% annuel)",
        color_continuous_scale=['red', 'yellow', 'green'],
        template='plotly_white',
        title=f'<b>Croissance du PIB (% annuel) & investissement  by {groupby_column}</b>'
    )
    st.plotly_chart(fig)
